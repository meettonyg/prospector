...
/**
 * Class Interview_Finder_Error_Handler
 *
...
class Interview_Finder_Error_Handler {
     ...
     * Singleton instance.
     *
     * @var Interview_Finder_Error_Handler|null
     */
    private static ?Interview_Finder_Error_Handler $instance = null;
     ...
     */
    public static function get_instance(): Interview_Finder_Error_Handler {
     ...
     * Set logger.
     *
     * @param Interview_Finder_Logger $logger Logger instance.
     * @return void
     */
    public function set_logger( Interview_Finder_Logger $logger ): void {
        $this->logger = $logger;
    }
