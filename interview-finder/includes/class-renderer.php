...
/**
 * Class Interview_Finder_Renderer
 *
...
class Interview_Finder_Renderer {
     ...
     * Singleton instance.
     *
     * @var Interview_Finder_Renderer|null
     */
    private static ?Interview_Finder_Renderer $instance = null;

    /**
     * RSS Cache instance.
     *
     * @var Interview_Finder_RSS_Cache|null
     */
    private ?Interview_Finder_RSS_Cache $rss_cache = null;
     ...
     *
     * @return Interview_Finder_Renderer
     */
    public static function get_instance(): Interview_Finder_Renderer {
    ...
    private function __construct() {
        if ( class_exists( 'Interview_Finder_RSS_Cache' ) ) {
            $this->rss_cache = Interview_Finder_RSS_Cache::get_instance();
        }
    }
