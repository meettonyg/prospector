...
/**
 * Class Interview_Finder_Admin_Dashboard
 *
...
class Interview_Finder_Admin_Dashboard {
     ...
     * Database instance.
     *
     * @var Interview_Finder_Database
     */
    private Interview_Finder_Database $database;

    /**
     * Constructor.
     *
     * @param Interview_Finder_Database|null $database Database instance.
     */
    public function __construct( ?Interview_Finder_Database $database = null ) {
        $this->database = $database ?? Interview_Finder_Database::get_instance();
    }
