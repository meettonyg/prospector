...
/**
 * Class Interview_Finder_Sponsored_Listings
 *
...
class Interview_Finder_Sponsored_Listings {
     ...
     * @var string
     */
    const TABLE_NAME = 'interview_finder_sponsored';
     ...
     * @var string
     */
    const STATS_TABLE_NAME = 'interview_finder_sponsored_stats';
     ...
     */
    private static ?Interview_Finder_Sponsored_Listings $instance = null;
     ...
     *
     * @return Interview_Finder_Sponsored_Listings
     */
    public static function get_instance(): Interview_Finder_Sponsored_Listings {
    ...
    public function create_tables(): bool {
        ...
        update_option( 'interview_finder_sponsored_db_version', self::DB_VERSION );
