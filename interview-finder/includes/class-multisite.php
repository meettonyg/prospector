...
/**
 * Class Interview_Finder_Multisite
 *
...
class Interview_Finder_Multisite {
     ...
     * Singleton instance.
     *
     * @var Interview_Finder_Multisite|null
     */
    private static ?Interview_Finder_Multisite $instance = null;
    ...
    private const NETWORK_OPTIONS = [
        'interview_finder_network_enabled',
        'interview_finder_network_api_keys',
        'interview_finder_network_settings',
    ];

    /**
     * Get singleton instance.
     *
     * @return Interview_Finder_Multisite
     */
    public static function get_instance(): Interview_Finder_Multisite {
    ...
    public function init(): void {
        ...
        add_action( 'network_admin_edit_interview_finder_network', [ $this, 'save_network_settings' ] );
        ...
        add_filter( 'pre_option_interview_finder_podcastindex_key', [ $this, 'maybe_use_network_key' ], 10, 3 );
        add_filter( 'pre_option_interview_finder_podcastindex_secret', [ $this, 'maybe_use_network_secret' ], 10, 3 );
        add_filter( 'pre_option_interview_finder_taddy_api_key', [ $this, 'maybe_use_network_taddy_key' ], 10, 3 );
        add_filter( 'pre_option_interview_finder_taddy_user_id', [ $this, 'maybe_use_network_taddy_user' ], 10, 3 );
    }
    ...
    public function render_network_settings(): void {
        ...
        <div class="wrap">
            ...
            <form method="post" action="<?php echo esc_url( network_admin_url( 'edit.php?action=interview_finder_network' ) ); ?>">
                <?php wp_nonce_field( 'interview_finder_network_settings', 'if_network_nonce' ); ?>
    ...
    public function save_network_settings(): void {
        check_admin_referer( 'interview_finder_network_settings', 'if_network_nonce' );
        ...
        update_site_option( 'interview_finder_network_api_keys', $api_keys );
        ...
        update_site_option( 'interview_finder_network_settings', $settings );
    ...
    public function get_network_settings(): array {
        ...
        return wp_parse_args( get_site_option( 'interview_finder_network_settings', [] ), $defaults );
    }
    ...
    public function get_network_api_keys(): array {
        return get_site_option( 'interview_finder_network_api_keys', [] );
    }
    ...
    public function on_site_created( WP_Site $new_site, array $args ): void {
        ...
        if ( class_exists( 'Interview_Finder_Database' ) ) {
            Interview_Finder_Database::get_instance()->create_tables();
        }

        // Set default options from network
        $settings = $this->get_network_settings();
        update_option( 'interview_finder_log_level', $settings['default_log_level'] );
    ...
    public function on_site_deleted( WP_Site $old_site ): void {
        ...
        global $wpdb;
        $wpdb->query( "DROP TABLE IF EXISTS {$wpdb->prefix}interview_finder_users" );

        // Delete options
        delete_option( 'interview_finder_podcastindex_key' );
        delete_option( 'interview_finder_podcastindex_secret' );
        delete_option( 'interview_finder_taddy_api_key' );
        delete_option( 'interview_finder_taddy_user_id' );
        delete_option( 'interview_finder_form_id' );
        delete_option( 'interview_finder_log_level' );
