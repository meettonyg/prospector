/**
 * Interview Finder - Modern JavaScript Module
 *
...
(function() {
    ...
    /**
     * Interview Finder Application Class
     */
    class InterviewFinder {
        /**
         * Constructor
         */
        constructor() {
            ...
            this.restUrl = this.config.restUrl || '/wp-json/interview-finder/v1';
    ...
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', () => {
            window.interviewFinder = new InterviewFinder();
        });
    } else {
        window.interviewFinder = new InterviewFinder();
    }
