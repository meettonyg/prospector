...
?>
<div class="if-results if-results--youtube" role="region" aria-label="<?php esc_attr_e( 'YouTube Video Results', 'podcast-prospector' ); ?>">
    <p class="if-results__count">
        <?php
        printf(
            /* translators: %d: number of results */
            esc_html( _n( '%d video found', '%d videos found', count( $items ), 'podcast-prospector' ) ),
            count( $items )
        );
        ?>
    </p>
