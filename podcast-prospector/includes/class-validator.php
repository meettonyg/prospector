...
/**
 * Class Podcast_Prospector_Validator
 *
...
class Podcast_Prospector_Validator {
     ...
     * Singleton instance.
     *
     * @var Podcast_Prospector_Validator|null
     */
    private static ?Podcast_Prospector_Validator $instance = null;
    ...
    /**
     * Genre short-name to Taddy enum mapping for backwards compatibility.
     *
     * @var array
     */
    private const GENRE_SHORT_MAP = [
     ...
     *
     * @return Podcast_Prospector_Validator
     */
    public static function get_instance(): Podcast_Prospector_Validator {
    ...
    public function validate_genre( string $genre ): string {
        ...
        return self::GENRE_SHORT_MAP[ $genre ] ?? 'ALL';
    }
     ...
     * @return Podcast_Prospector_Validation_Result
     */
    public function validate_search_request( array $input ): Podcast_Prospector_Validation_Result {
        $result = new Podcast_Prospector_Validation_Result();
     ...
     * @return Podcast_Prospector_Validation_Result
     */
    public function validate_import_request( array $input ): Podcast_Prospector_Validation_Result {
        $result = new Podcast_Prospector_Validation_Result();
...
/**
 * Class Podcast_Prospector_Validation_Result
 *
