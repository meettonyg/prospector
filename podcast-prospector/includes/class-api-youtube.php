...
/**
 * Class Podcast_Prospector_API_YouTube
 *
...
class Podcast_Prospector_API_YouTube {
     ...
     *
     * @var Podcast_Prospector_Rate_Limiter|null
     */
    private ?Podcast_Prospector_Rate_Limiter $rate_limiter;

    /**
     * Constructor.
     *
     * @param Podcast_Prospector_Settings         $settings     Settings instance.
     * @param Podcast_Prospector_Logger|null      $logger       Logger instance.
     * @param Podcast_Prospector_Rate_Limiter|null $rate_limiter Rate limiter instance.
     */
    public function __construct(
        Podcast_Prospector_Settings $settings,
        ?Podcast_Prospector_Logger $logger = null,
        ?Podcast_Prospector_Rate_Limiter $rate_limiter = null
    ) {
