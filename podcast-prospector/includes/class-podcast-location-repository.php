...
/**
 * Class Podcast_Prospector_Podcast_Location_Repository
 *
...
class Podcast_Prospector_Podcast_Location_Repository {
     ...
     */
    public function __construct( Podcast_Prospector_Settings $settings, ?Podcast_Prospector_Logger $logger = null ) {
        global $wpdb;
        $this->wpdb = $wpdb;
